  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'The architectural reason for this insistence is in §3.4 (PCN-QFT correspondence) and §3.1 (single F objective): *belief* and *evidence* are not different kinds of thing in the QPCN — they are two views of the same underlying entanglement structure, and both sides minimise the same free-energy functional. A unidirectional bridge would silently pick one view as canonical and demote the other to "input." The bidirectional bridge refuses to make that choice. In practice, this means you can run the §4.2 panel "data-first" (load observations, let the PCN drive) or "theory-first" (set a Hamiltonian, let the QFT drive) and both reach valid coupled fixed points — the system has no preferred direction of fit.',
      ],
    },
    {
      kind: 'prose',
